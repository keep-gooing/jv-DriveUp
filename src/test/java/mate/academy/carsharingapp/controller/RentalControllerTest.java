...
public class RentalControllerTest {
    ...
    void addRental_ValidRequestDto_Success() throws Exception {
        ...
        assertEquals(requestDto.getCarId(), actualDto.getCarId());
        assertEquals(requestDto.getRentalDate(), actualDto.getRentalDate());
        assertEquals(requestDto.getReturnDate(), actualDto.getReturnDate());
    }
    ...
    void getRentalsByUserId_Active_Success() throws Exception {
        ...
        assertTrue(actualRentals.size() >= 1);
        assertEquals(VALID_RENTAL_ID, actualRentals.get(0).getId());
    }
    ...
    void getSpecificRental_ValidIds_Success() throws Exception {
        ...
        assertEquals(VALID_RENTAL_ID, actualDto.getId());
    }
}
